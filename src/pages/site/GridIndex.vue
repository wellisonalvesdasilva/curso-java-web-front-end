...
<span style="font-size: 1rem; color: #9c27b0; font-weight: bold;">
 ...
 <picture>
    <!-- Mobile -->
    <source srcset="/src/assets/img/logo-mercado-instrumental-index-807x376.png" media="(max-width: 768px)" />

    <!-- Tablet -->
    <source srcset="/src/assets/img/logo-mercado-instrumental-index-1135-350.png" media="(max-width: 1200px)" />

    <!-- Desktop (default) -->
<img
  @click="irParaAreaAnunciante"
  src="/src/assets/img/logo-mercado-instrumental-index-1576-300.png"
