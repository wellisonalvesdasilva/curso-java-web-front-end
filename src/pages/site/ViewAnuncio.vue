    ...
    <div class="bg main-wrapper">
      ...
      <q-form greedy>
        ...
        <picture class="q-mb-lg">
          <!-- Mobile -->
          <source @click="voltar" srcset="/img/logo-mercado-instrumental-detail-807x376.png" media="(max-width: 768px)" />
          <!-- Tablet -->
          <source @click="voltar" srcset="/img/logo-mercado-instrumental-detail-1135x350.png" media="(max-width: 1200px)" />
          <!-- Desktop (default) -->
          <img @click="voltar" src="/img/logo-mercado-instrumental-detail-1576x300.png" alt="Banner Anuncie aqui"
